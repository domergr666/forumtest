                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Добавление сервера</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form method="post" id="addserver" class="form-horizontal">
											...
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Название сервера из BungeeCord</label>
                                                </div>
                                                <div class="col-12 col-md-9">
