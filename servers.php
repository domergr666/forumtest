                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Серверы</h3>
                                <div class="table-data__tool">
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <a href="<?=$realdir?>/admin/addserver" style="color: white;"><i class="zmdi zmdi-plus"></i>Добавить сервер</a>
                                        </button>
                                    </div>
                                </div>
											...
											if($rows > 0)
											{
												for ($i; $i < $rows; $i++)
												{
													...
													'<tr class="tr-shadow">
                                                        ...
                                                        <td>'.$server['code'].'</td>
                                                        <td>
                                            		    <div class="deleteserver" data-id="'.$server['id'].'">
